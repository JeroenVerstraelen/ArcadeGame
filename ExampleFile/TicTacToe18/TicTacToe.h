...
bool legalMoves(const char *stringWithMoves);
...
\n REQUIRE(legalMoves(oMoves), "TicTacToe::setMoves requires legal oMoves");
\n REQUIRE(legalMoves(xMoves), "TicTacToe::setMoves requires legal xMoves");
*/
	void setMoves(const char *stringWithMoves);

/**
// Performs a move an returns whether this was a winning move or not
...
\n REQUIRE(legalMoves(oMoves));
\n REQUIRE(legalMoves(xMoves));
*/
	void setMoves(const char *oMoves, const char *xMoves);
